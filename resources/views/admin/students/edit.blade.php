                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.students.update', $student->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="student_number" class="block mt-1 w-full" type="text" name="student_number" :value="old('student_number', $student->student_number)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="address" name="address" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('address', $student->address) }}</textarea>
