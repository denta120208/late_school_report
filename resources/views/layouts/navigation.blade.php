        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <x-nav-link :href="route('late-attendance.index')" :active="request()->routeIs('late-attendance.*')" class="!text-white hover:!bg-white hover:!bg-opacity-20 !border-transparent hover:!border-white">
                        <svg class="w-5 h-5 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
